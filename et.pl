...
sub print_expenses {
    ...
    my $total              = 999.45;
    my $template_directory = 'V:\\_data\\templates2';
...
sub open_db_with_ini {
    ...
    if ($debug) {
        ...
        print "----------------------------------\n";
        print
          "connection string : $config->{$ini_section}->{connection_string}\n";
...
=head2 SAXER ACCOUNTING CODES

Here are the internal accounts that are used by the Account company just as an Aide-Memoire.


  4090	sonstiger Personalaufwand
  4100	Mietaufwand
  4110	Mietnebenkosten
  4200	Bankspesen, Debetzinsen
  4300	Unterhalt und Reparaturen Büro
  4310	Unterhalt EDV
  4305	Support Verträge
  4320	Unterhalt und Reparaturen Fahrzeug
  4321	2/7 PA Fahrzeugkosten
  4400	Abschreibungen
  4500	Geschäfts- Sachversicherungen
  4700	Büromaterial, Drucksachen
  4710	Telefon, Fax, Internet
  4711	20% PA Telefon- und Internetkosten
  4715	Porti
  4720	Beiträge, Gebühren
  4750	Fachliteratur
  4760	Buchhaltungs- und Beratungskosten
  4790	sonstiger Verwaltungsaufwand
  4800	Werbung, Inserate
  4830	Reisekosten
  4831	Repräsentationskosten
  4832	20% PA Repräsentationskosten
  4900	Weiterbildung
  4999	Gewinn
  6000	Einnahmen aus Arbeiten
  6005	sonstige Einnahmen
  6040	./. Mehrwertsteuer VAT
  6100	Zinsertrag (brutto)
  7600	Steueraufwand
